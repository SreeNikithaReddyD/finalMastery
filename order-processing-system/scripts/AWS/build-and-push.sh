...
# Usage: ./scripts/AWS/build-and-push.sh
...
docker buildx build --platform linux/amd64 \
  -f deployments/aws/Dockerfile.order-service \
...
docker buildx build --platform linux/amd64 \
  -f deployments/aws/Dockerfile.payment-worker \
  -t payment-worker:latest \
  ./src --load
...
echo "========================================"
echo ""
echo "Next: Deploy to ECS"
echo "Run: ./scripts/AWS/deploy-ecs.sh"